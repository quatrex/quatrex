...
add_kernel_comp = cp.RawKernel(
    r"""
                        #include <cupy/complex.cuh>
                        extern "C" __global__
                        void add_comp_func(complex<double>* M, const complex<double>* U,
...
add_OBC_inplace = cp.RawKernel(
    r"""
                        #include <cupy/complex.cuh>
                                
                        extern "C" __global__
                        void add_OBC(complex<double>* M, const complex<double>* S, const double K1, const double K2, const int N_S_big, const int N_S, const int n_rep_2,
                                    const long long* ind, const int N) {
