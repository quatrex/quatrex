...
def transver_self_energy_simple(g, m_interaction, d):
    ...
    # Get the term for the polarization
    __, path_info1 = oe.contract_path(
        "jiu,il,lkv,ikuv->jk", m_interaction, g, m_interaction, d
    )
    print(path_info1)
    ...
    __, path_info2 = oe.contract_path(
        "iju,il,lkv,iluv->jk", m_interaction, g, m_interaction, d
    )  # weird
    print(path_info2)
    ...
    __, path_info3 = oe.contract_path(
        "iju,il,lkv,lkuv->jk", m_interaction, g, m_interaction, d
    )  # make sense
    print(path_info3)
    ...
    __, path_info4 = oe.contract_path(
        "iju,il,lkv,jluv->jk", m_interaction, g, m_interaction, d
    )  # weird
    print(path_info4)
